...
use Cristian\TodosBackend\Repositories\TaskRepository;
...
class TasksController extends Controller
{
    ...
    {
//        $user = Auth::user();
//        if ($user->can('show', \Cristian\TodosBackend\Task::class)) {
//            //
//        }

        //$this->authorize('show-task', \Cristian\TodosBackend\Task::class);
